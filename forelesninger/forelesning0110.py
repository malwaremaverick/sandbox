...
while kjør:
    ...
    for planetnummer, planet in enumerate(planeter, start=1):
    ...
    if 0 <= valgt_planetnummer < len(planeter):
        ...
        print(f"Din vekt på planeten {valgt_planet} er {din_vekt_på_planet:.2f} kg, som har tyngdekraft {tyngdekraft[valgt_planetnummer]:.2f}")
    else:
        print("Ugyldig valg, prøv igjen!")
